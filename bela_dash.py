...
def run_bela_dash():
    ...
    # Dataset
    df = pd.read_excel("data/belaok_20220708.xlsx", sheet_name="list_po")
    dfsku = pd.read_excel("data/belaok_20220708.xlsx", sheet_name="list_sku")
    dfv = pd.read_excel("data/belaok_20220708.xlsx", sheet_name="list_vendor")
