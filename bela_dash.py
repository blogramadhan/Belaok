...
def run_bela_dash():
    ...
    # Dataset
    df = pd.read_excel("https://storage.googleapis.com/belaok_ramadhan/belaok_mentah_16042022.xlsx", sheet_name="list_po")
    dfsku = pd.read_excel("https://storage.googleapis.com/belaok_ramadhan/belaok_mentah_16042022.xlsx", sheet_name="list_sku")
    dfv = pd.read_excel("https://storage.googleapis.com/belaok_ramadhan/belaok_mentah_16042022.xlsx", sheet_name="list_vendor")
    ...
    b2.metric("PO Delivered (Rp.)", po_delivered)
    b3.metric("PO Close (Rp.)", po_close)
